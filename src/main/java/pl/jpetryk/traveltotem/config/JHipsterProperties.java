package pl.jpetryk.traveltotem.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "traveltotem@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "traveltotem API";

        private String description = "traveltotem API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "traveltotem";
